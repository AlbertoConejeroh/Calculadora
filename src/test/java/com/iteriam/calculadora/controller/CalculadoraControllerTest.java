...
public class CalculadoraControllerTest {
	...
	@Mock
	private ICalculadoraService iCalcService;

	@InjectMocks
	private CalculadoraController calcController;
	...
	public void controllerTest() throws CustomException {
		when(iCalcService.calcula(new BigDecimal("1".replace(",", ".")), new BigDecimal("1".replace(",", ".")), "suma"))
